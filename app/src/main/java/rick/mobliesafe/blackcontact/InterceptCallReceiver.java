        ...
        if (!intent.getAction().equals(Intent.ACTION_NEW_OUTGOING_CALL)){
            ...
            switch (tManager.getCallState()){
                case TelephonyManager.CALL_STATE_RINGING:
                    ...
                    Log.i("testing","mIncomingNumber="+mIncomingNumber);
                    int blackContactMode=dao.getBlackContactMode(mIncomingNumber);
                    boolean isExist=dao.IsNumberExist(mIncomingNumber);
                    Log.i("testing","exist="+isExist);
                    Log.i("testing","blackContactMode="+blackContactMode);
